...
--
-- Name: role; Type: TABLE; Schema: app_public; Owner: cp_postgraphile
--

CREATE TABLE app_public.role (
    id uuid DEFAULT public.uuid_generate_v1mc() NOT NULL,
    role_holder_id uuid NOT NULL,
    event_id uuid NOT NULL,
    account uuid,
    bio text,
...
ALTER TABLE app_public.role OWNER TO cp_postgraphile;


--
-- Name: TABLE role; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON TABLE app_public.role IS 'Roles of accounts with respect to specific events, this table joins accounts and events and contains role-specific information';


--
-- Name: COLUMN role.id; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.id IS 'Unique ID for this role';


--
-- Name: COLUMN role.role_holder_id; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.role_holder_id IS 'The id of the account acting in this role';


--
-- Name: COLUMN role.event_id; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--


COMMENT ON COLUMN app_public.role.event_id IS 'The event this role is associated with';

--
-- Name: COLUMN role.account; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.account IS 'ID of the account that created/assigned this role';


--
-- Name: COLUMN role.bio; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.bio IS 'The bio of this account specific to this role';


--
-- Name: COLUMN role.role_type; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.role_type IS 'The type of role this account is acting as within the event (e.g. speaker, facilitator, attendee)';


--
-- Name: COLUMN role.created_at; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.created_at IS 'The date and time this role was created.';


--
-- Name: COLUMN role.updated_at; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role.updated_at IS 'The date and time this role was last updated.';



--
-- Name: role_type; Type: TABLE; Schema: app_public; Owner: cp_postgraphile
--

CREATE TABLE app_public.role_type (
    id uuid DEFAULT public.uuid_generate_v1mc() NOT NULL,
...
ALTER TABLE app_public.role_type OWNER TO cp_postgraphile;

--
-- Name: TABLE role_type; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON TABLE app_public.role_type IS 'Types of roles an account can have with respect to a given event e.g. speaker, staff, attendee.';


--
-- Name: COLUMN role_type.id; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role_type.id IS 'The primary key for this role type.';


--
-- Name: COLUMN role_type.name; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role_type.name IS 'The unique name for this role type.';


--
-- Name: COLUMN role_type.account; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role_type.account IS 'The id of the account that created this role type.';


--
-- Name: COLUMN role_type.created_at; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role_type.created_at IS 'The date and time this role type was created.';


--
-- Name: COLUMN role_type.updated_at; Type: COMMENT; Schema: app_public; Owner: cp_postgraphile
--

COMMENT ON COLUMN app_public.role_type.updated_at IS 'The date and time this role type was last updated.';
...
--
-- Name: role role_pkey; Type: CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role
    ADD CONSTRAINT role_pkey PRIMARY KEY (id);


--
-- Name: role_type role_type_name_key; Type: CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role_type
    ADD CONSTRAINT role_type_name_key UNIQUE (name);


--
-- Name: role_type role_type_pkey; Type: CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--
...
--
-- Name: unique_roles; Type: INDEX; Schema: app_public; Owner: cp_postgraphile
--

CREATE UNIQUE INDEX unique_roles ON app_public.role USING btree (role_holder_id, event_id, role_type);
...
-- Name: role role_account; Type: TRIGGER; Schema: app_public; Owner: cp_postgraphile
--

CREATE TRIGGER role_account BEFORE INSERT ON app_public.role FOR EACH ROW EXECUTE PROCEDURE app_private.set_account();


--
-- Name: role role_updated_at; Type: TRIGGER; Schema: app_public; Owner: cp_postgraphile
--

CREATE TRIGGER role_updated_at BEFORE UPDATE ON app_public.role FOR EACH ROW EXECUTE PROCEDURE app_private.set_updated_at();


--
-- Name: role_type role_type_account; Type: TRIGGER; Schema: app_public; Owner: cp_postgraphile
--

CREATE TRIGGER role_type_account BEFORE INSERT ON app_public.role_type FOR EACH ROW EXECUTE PROCEDURE app_private.set_account();


--
-- Name: role_type role_type_updated_at; Type: TRIGGER; Schema: app_public; Owner: cp_postgraphile
--

CREATE TRIGGER role_type_updated_at BEFORE UPDATE ON app_public.role_type FOR EACH ROW EXECUTE PROCEDURE app_private.set_updated_at();
...
-- Name: role_type role_type_account_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role_type
    ADD CONSTRAINT role_type_account_fkey FOREIGN KEY (account) REFERENCES app_public.account(id);
...
--
-- Name: role role_role_holder_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role
    ADD CONSTRAINT role_role_holder_fkey FOREIGN KEY (role_holder_id) REFERENCES app_public.account(id) ON DELETE CASCADE;


--
-- Name: role role_event_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role
    ADD CONSTRAINT role_event_id_fkey FOREIGN KEY (event_id) REFERENCES app_public.event(id) ON DELETE CASCADE;


--
-- Name: role role_account_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role
    ADD CONSTRAINT role_account_fkey FOREIGN KEY (account) REFERENCES app_public.account(id);


--
-- Name: role role_role_type_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE ONLY app_public.role
    ADD CONSTRAINT role_role_type_fkey FOREIGN KEY (role_type) REFERENCES app_public.role_type(id);


--
-- Name: account_hypertext_link account_hypertext_link_account_id_fkey; Type: FK CONSTRAINT; Schema: app_private; Owner: cp_postgraphile
--
...
--
-- Name: account_hypertext_link account_hypertext_link_hypertext_link_id_fkey; Type: FK CONSTRAINT; Schema: app_private; Owner: cp_postgraphile
--
...
--
-- Name: role; Type: ROW SECURITY; Schema: app_public; Owner: cp_postgraphile
--
...
--
-- Name: role_type; Type: ROW SECURITY; Schema: app_public; Owner: cp_postgraphile
--

ALTER TABLE app_public.role_type ENABLE ROW LEVEL SECURITY;
...
-- Name: role select_role; Type: POLICY; Schema: app_public; Owner: cp_postgraphile
--

CREATE POLICY select_role ON app_public.role FOR SELECT USING (true);


--
-- Name: role_type select_role_type; Type: POLICY; Schema: app_public; Owner: cp_postgraphile
--

CREATE POLICY select_role_type ON app_public.role_type FOR SELECT USING (true);
